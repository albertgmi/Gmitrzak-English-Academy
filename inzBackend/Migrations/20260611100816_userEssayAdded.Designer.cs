...
namespace inzBackend.Migrations
{
    ...
    [Migration("20260611100816_userEssayAdded")]
    partial class userEssayAdded
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("inzBackend.Entities.Announcement", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("inzBackend.Entities.AnnouncementRecipient", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("inzBackend.Entities.Credit", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("inzBackend.Entities.SentenceSetItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("inzBackend.Entities.SentenceStock", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("inzBackend.Entities.ShopItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTimeOffset(new DateTime(2026, 6, 11, 12, 8, 14, 608, DateTimeKind.Unspecified).AddTicks(3176), new TimeSpan(0, 2, 0, 0, 0)),
                            CreditCost = 10,
                        ...
                        {
                            Id = 2,
                            CreatedAt = new DateTimeOffset(new DateTime(2026, 6, 11, 12, 8, 14, 608, DateTimeKind.Unspecified).AddTicks(3334), new TimeSpan(0, 2, 0, 0, 0)),
                            CreditCost = 20,
                        ...
                        {
                            Id = 3,
                            CreatedAt = new DateTimeOffset(new DateTime(2026, 6, 11, 12, 8, 14, 608, DateTimeKind.Unspecified).AddTicks(3339), new TimeSpan(0, 2, 0, 0, 0)),
                            CreditCost = 15,
                        ...
                        {
                            Id = 4,
                            CreatedAt = new DateTimeOffset(new DateTime(2026, 6, 11, 12, 8, 14, 608, DateTimeKind.Unspecified).AddTicks(3351), new TimeSpan(0, 2, 0, 0, 0)),
                            CreditCost = 25,
                        ...
                        {
                            Id = 5,
                            CreatedAt = new DateTimeOffset(new DateTime(2026, 6, 11, 12, 8, 14, 608, DateTimeKind.Unspecified).AddTicks(3368), new TimeSpan(0, 2, 0, 0, 0)),
                            CreditCost = 30,
            ...
            modelBuilder.Entity("inzBackend.Entities.ShopPurchase", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("inzBackend.Entities.UserEssay", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("inzBackend.Entities.UserSentenceAssignment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("inzBackend.Entities.Announcement", b =>
                {
                    b.HasOne("inzBackend.Models.AppUser", "Sender")
                        .WithMany()
            ...
            modelBuilder.Entity("inzBackend.Entities.AnnouncementRecipient", b =>
                {
                    b.HasOne("inzBackend.Entities.Announcement", "Announcement")
                        .WithMany("Recipients")
            ...
            modelBuilder.Entity("inzBackend.Entities.ModuleSentenceSet", b =>
                {
                    ...
                    b.HasOne("inzBackend.Entities.SentenceSet", "SentenceSet")
                        .WithMany()
            ...
            modelBuilder.Entity("inzBackend.Entities.SentenceSetItem", b =>
                {
                    ...
                    b.HasOne("inzBackend.Entities.SentenceStock", "SentenceStock")
                        .WithMany("SetItems")
            ...
            modelBuilder.Entity("inzBackend.Entities.ShopPurchase", b =>
                {
                    b.HasOne("inzBackend.Entities.ShopItem", "ShopItem")
                        .WithMany()
